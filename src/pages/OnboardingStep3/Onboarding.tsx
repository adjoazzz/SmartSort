...
export default function Onboarding() {
  ...
  const [cameraState, setCameraState] = useState<
    "loading" | "scanning" | "permission_denied" | "success"
  >("loading");
  ...
  const handleScanSuccess = (
    decodedText: string,
    qrScannerInstance: Html5Qrcode | null,
  ) => {
  ...
  const handleSimulateScan = () => {
    ...
    setTimeout(() => {
      ...
      const randomSerial =
        mockSerials[Math.floor(Math.random() * mockSerials.length)];
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="absolute top-10 left-10 flex flex-col gap-6 z-20">
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-[#006c49] dark:text-emerald-400 tracking-wide text-sm hidden sm:block">
                    Facility Mapping
                  </span>
                </div>
              </div>
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm p-6 sm:p-8 flex flex-col gap-6">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Enter the unique 12-digit serial number located on the side panel
              of your SmartSort unit to activate its analytics core.
            </p>

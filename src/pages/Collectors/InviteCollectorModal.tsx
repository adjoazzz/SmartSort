      ...
      <div className="bg-white dark:bg-[#0b1c30] rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col relative">
        ...
        <div className="border-b border-[#e2e8f0] dark:border-[#1e3a5f] px-6 py-4 flex items-center justify-between bg-[#f8fafc] dark:bg-[#0f2942]">
          ...
          <button 
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#f1f5f9] dark:bg-[#1a365d] text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] transition-colors disabled:opacity-50"
          >
        ...
        {status === 'success' ? (
          ...
          <form onSubmit={handleInvite} className="p-6 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="region" className="text-xs font-semibold text-[#515f74] dark:text-[#cbd5e1] uppercase tracking-wider">
                Assigned Region
              </label>
              <select
                id="region"
            ...
            <div className="flex gap-3 justify-end mt-2 pt-4 border-t border-[#f1f5f9] dark:border-[#0f2942]">
              <button 
                type="button" 
                onClick={onClose}
                className="px-4 py-2 text-sm font-semibold text-[#515f74] dark:text-[#cbd5e1] hover:bg-[#f1f5f9] dark:bg-[#1a365d] rounded-lg transition-colors"
              >
                Cancel
              </button>
              <button 

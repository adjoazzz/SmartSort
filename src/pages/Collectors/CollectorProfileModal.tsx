        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div className="bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl shadow-sm overflow-hidden flex flex-col items-center p-6">
              ...
              <h2 className="text-xl font-bold text-[#0b1c30] dark:text-white">{collector.name}</h2>
              <p className="text-sm font-medium text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] mb-4">ID: {collector.id}</p>
              ...
              <div className="w-full mt-6 pt-6 border-t border-[#e2e8f0] dark:border-[#1e3a5f] flex flex-col gap-3">
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b]">Region</span>
                  <span className="text-sm font-semibold text-[#0b1c30] dark:text-white">{collector.region}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b]">Joined</span>
                  <span className="text-sm font-semibold text-[#0b1c30] dark:text-white">Mar 2024</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b]">Contact</span>
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl p-4 shadow-sm flex flex-col">
                <span className="text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider mb-1">Total Collections</span>
                <span className="text-2xl font-bold text-[#0b1c30] dark:text-white">1,284</span>
              </div>
              <div className="bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl p-4 shadow-sm flex flex-col">
                <span className="text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider mb-1">Avg Rating</span>
                <span className="text-2xl font-bold text-[#0b1c30] dark:text-white">{collector.rating} <span className="text-sm text-[#d97706]">⭐</span></span>
              </div>
              <div className="bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl p-4 shadow-sm flex flex-col col-span-2 md:col-span-1">
                <span className="text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider mb-1">On-Time Rate</span>
                <span className="text-2xl font-bold text-[#0b1c30] dark:text-white">96.5%</span>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl shadow-sm flex flex-col flex-1">
              <div className="p-4 border-b border-[#f1f5f9] dark:border-[#0f2942] flex justify-between items-center bg-[#f8fafc] dark:bg-[#0f2942]">
                <h3 className="text-lg font-semibold text-[#0b1c30] dark:text-white">Recent Jobs</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-white dark:bg-[#0b1c30] border-b border-[#f1f5f9] dark:border-[#0f2942]">
                      <th className="px-6 py-3 text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider">Date</th>
                      <th className="px-6 py-3 text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider">Location</th>
                      <th className="px-6 py-3 text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider">Volume</th>
                      <th className="px-6 py-3 text-xs font-semibold text-[#64748b] dark:text-[#94a3b8] dark:text-[#64748b] uppercase tracking-wider">Status</th>
                    </tr>
                  </thead>

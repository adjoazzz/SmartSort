      ...
      actions={
        <div className="flex bg-white dark:bg-[#0b1c30] border border-[#e2e8f0] dark:border-[#1e3a5f] rounded-xl shadow-sm divide-x divide-[#f1f5f9] overflow-hidden">
          <div className="px-6 py-3 flex flex-col items-center justify-center">
            <span className="text-[10px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider uppercase mb-1">CRITICAL</span>
            <span className="text-[28px] leading-none font-bold text-[#ba1a1a]">03</span>
          </div>
          <div className="px-6 py-3 flex flex-col items-center justify-center">
            <span className="text-[10px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider uppercase mb-1">WARNINGS</span>
            ...
            <table className="w-full text-left border-collapse min-w-[900px]">
              <thead>
                <tr className="border-b border-[#e2e8f0] dark:border-[#1e3a5f]">
                  <th className="px-6 py-4 text-[11px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider">DEVICE</th>
                  <th className="px-6 py-4 text-[11px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider">SEVERITY</th>
                  <th className="px-6 py-4 text-[11px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider w-[40%]">MESSAGE</th>
                  <th className="px-6 py-4 text-[11px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider">TIMESTAMP</th>
                  <th className="px-6 py-4 text-[11px] font-bold text-[#64748b] dark:text-[#94a3b8] tracking-wider">ACTIONS</th>
                </tr>
              </thead>
                ...
                {ALERTS_DATA.map((alert) => (
                  <tr key={alert.id} className="hover:bg-[#f8fafc] dark:bg-[#0f2942] transition-colors">
                    <td className="px-6 py-5 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[12px] text-[#64748b] dark:text-[#94a3b8] mt-0.5">{alert.deviceLocation}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-5 whitespace-nowrap">
                    ...
                    <td className="px-6 py-5 whitespace-nowrap">
                      ...
                      <div className="text-[12px] text-[#64748b] dark:text-[#94a3b8] mt-0.5">{alert.timestampSub}</div>
                    </td>
                    <td className="px-6 py-5 whitespace-nowrap">

...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-card text-foreground dark:text-white transition-colors duration-300 font-sans">
      ...
      <header className="h-20 bg-white/80 dark:bg-card/80 backdrop-blur-md border-b border-border/50 dark:border-border/50 flex items-center justify-between px-6 sm:px-12 sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-10">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-semibold text-muted-foreground">
            <a
              href="#features"
              className="hover:text-[#006c49] dark:hover:text-[#6ffbbe] transition-colors"
            >
              Features
            </a>
            <a
            ...
            <a
              ...
              className="hover:text-[#006c49] dark:hover:text-[#6ffbbe] transition-colors cursor-pointer"
            >
              Inquiry
            </a>
          </nav>
      ...
      <section className="px-6 sm:px-12 py-16 sm:py-24 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-foreground dark:text-white tracking-tight leading-[1.15]">
            The Future of <br />
            <span className="text-[#2563eb] bg-gradient-to-r from-[#2563eb] to-[#006c49] bg-clip-text text-transparent">
              Waste Intelligence
            </span>
          </h1>

          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed font-normal">
            Automate your sorting logistics with AI-powered vision and real-time
            analytics. Scale efficiency and transparency across global supply
            chains.
          </p>
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-border/80 dark:border-border/50">
            ...
            <div>
              <p className="text-xs font-bold text-foreground dark:text-white">
                Trusted by 200+ Facilities
              </p>
              <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wider">
                Leading the industry in AI adoption
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section
        id="features"
        className="px-6 sm:px-12 py-20 sm:py-28 max-w-7xl mx-auto flex flex-col gap-12"
      >
        <div className="text-center flex flex-col gap-3 max-w-2xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Our suite of tools eliminates human error and optimizes operational
            throughput.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="flex-1 flex flex-col justify-between gap-6">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Our deep learning models are trained on over 50 million
                  labeled waste instances, ensuring near-perfect material
                  identification.
                </p>
              </div>
              <a
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <p className="text-xs text-white/80 leading-relaxed">
                Latency-free streaming of sorting sensor status at all your
                facilities via a unified dashboard.
              </p>
            </div>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Our SDK connects directly with existing SCADA systems and
                industrial PLCs without infrastructure overhaul.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="flex-1 flex flex-col gap-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Automatically generate certified reports for environmental
                audits and carbon credit verification.
              </p>
            </div>
      ...
      <section
        id="process"
        className="bg-[#eff6ff]/50 dark:bg-secondary/10 border-y border-border/40 dark:border-border/40 py-20 sm:py-28 px-6"
      >
        <div className="max-w-7xl mx-auto flex flex-col gap-16">
          <div className="text-center flex flex-col gap-3 max-w-xl mx-auto">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              A sophisticated pipeline from raw sensor data to optimized
              industrial sorting.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                High-speed multispectral cameras identify individual waste items
                on the conveyor belt in milliseconds.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="w-6 h-6 rounded-full bg-[#10b981] text-white text-xs font-bold flex items-center justify-center">
                2
              </div>
              <h3 className="text-lg font-bold">AI Classification</h3>
              <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                Our neural network classifies materials (HDPE, PET, Paper,
                Metal) with laboratory-grade precision.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="w-6 h-6 rounded-full bg-[#8b5cf6] text-white text-xs font-bold flex items-center justify-center">
                3
              </div>
              <h3 className="text-lg font-bold">Automated Sorting</h3>
              <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                Robotic actuators or air-jet systems execute precise physical
                separation at speeds up to 300 items per minute.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section
        id="inquiry-section"
        className="px-6 sm:px-12 py-20 sm:py-28 max-w-7xl mx-auto"
      >
        <div className="bg-card text-white border border-white/10 rounded-xl p-8 sm:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative overflow-hidden shadow-md">
          ...
          <div className="flex flex-col gap-6 relative z-10">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed font-light">
              Join the world's most advanced sorting facilities. Contact our
              solutions engineering team for a custom feasibility study.
            </p>
            <div className="flex flex-col gap-3 pt-2 text-xs sm:text-sm font-medium text-muted-foreground">
              <div className="flex items-center gap-3">
                <span className="w-5 h-5 rounded-full bg-[#10b981]/25 border border-[#10b981]/30 flex items-center justify-center text-[#10b981]">
                  ✓
                </span>
          ...
          <div className="bg-card text-foreground dark:text-white rounded-xl p-6 sm:p-8 border border-border shadow-xl relative z-10">
            {submitted ? (
              <div className="py-12 flex flex-col items-center justify-center text-center gap-4">
                ...
                <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">
                  Thank you! Our solutions engineering team will review your
                  info and contact you at{" "}
                  <span className="font-semibold">{form.email}</span> within 12
                  hours.
                </p>
              </div>
            ) : (
              <form
                ...
                style={
                  shaking
                    ? { animation: "inquiry-shake 0.4s ease-in-out" }
                    : undefined
                }
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">
                    Facility Tons Output (Tons/M)
                  </label>
                  <select
                    value={form.tonsRange}
                    onChange={(e) =>
                      setForm({ ...form, tonsRange: e.target.value })
                    }
                ...
                <p className="text-[10px] text-center text-muted-foreground font-medium mt-1">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-10">
            ...
            <div className="md:col-span-2 flex flex-col gap-4">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Redefining the industrial waste landscape through artificial
                intelligence and automated robotics. Built for a sustainable,
                data-driven future.
              </p>
              {/* Small Social Icons Mock */}
              <div className="flex gap-4.5 pt-2 text-muted-foreground">
                <span className="w-5 h-5 rounded bg-slate-200 dark:bg-[#1e3a5f] flex items-center justify-center font-bold text-xs cursor-pointer hover:text-[#2563eb]">
                  𝕏
                </span>
                <span className="w-5 h-5 rounded bg-slate-200 dark:bg-[#1e3a5f] flex items-center justify-center font-bold text-xs cursor-pointer hover:text-[#2563eb]">
                  in
            ...
            {[
              ...
              {
                title: "Company",
                items: ["About Us", "Sustainability", "Careers", "Press Kit"],
              },
              {
                title: "Resources",
                items: [
              ...
              {
                title: "Legal",
                items: ["Privacy Policy", "Terms of Use", "Ethics", "Security"],
              },
            ].map((col) => (
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-muted-foreground">
              &copy; 2026 SmartSort Intelligence Systems. All rights reserved.
            </p>

...
export default function Profile() {
  return (
    <PageLayout
      ...
      actions={
        <button className="bg-white border border-[#e2e8f0] text-[#0b1c30] text-sm font-medium rounded-lg px-4 py-2 hover:bg-[#f8fafc] transition-colors">
          Edit Profile
        </button>
      }
    >
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <div className="bg-white border border-[#e2e8f0] rounded-xl shadow-sm overflow-hidden flex flex-col items-center p-6">
            ...
            <h2 className="text-xl font-bold text-[#0b1c30]">Kwame Mensah</h2>
            <p className="text-sm font-medium text-[#64748b] mb-4">ID: COL-001</p>
            ...
            <div className="w-full mt-6 pt-6 border-t border-[#e2e8f0] flex flex-col gap-3">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-semibold text-[#0b1c30]">North Sector</span>
              </div>
              <div className="flex justify-between items-center">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white border border-[#e2e8f0] rounded-xl p-4 shadow-sm flex flex-col">
              ...
              <span className="text-2xl font-bold text-[#0b1c30]">4.8 <span className="text-sm text-[#d97706]">⭐</span></span>
            </div>

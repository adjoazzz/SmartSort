  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <select
        ...
        className="h-10 px-3 border border-[#cbd5e1] rounded-lg text-sm bg-white text-[#0b1c30] focus:outline-none focus:border-[#006c49] focus:ring-2 focus:ring-[#006c49]/10 transition-all appearance-none cursor-pointer"
        style={{
